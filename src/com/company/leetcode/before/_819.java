        ...
        for (String word : words) {
            if (!hashSet.contains(word.toLowerCase())) {
                if (map.containsKey(word.toLowerCase())) {
                    map.put(word.toLowerCase(), ((Integer) map.get(word.toLowerCase())) + 1);
                } else {
